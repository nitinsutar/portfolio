...
// One-Page Portfolio for Nitin Sutar
const projects = [
  {
    title: "OutlookMS",
    description: "Corporate presence done right. Straightforward, fast, professional.",
    tags: ["Corporate", "Web", "B2B"],
    link: "https://www.outlookms.com/",
    preview: "/previews/outlookms.png",
  },
  {
    title: "Raj Jewellers",
    description: "Luxury jewellery site—craftsmanship meets clean modern web.",
    tags: ["Branding", "Web Design", "Luxury"],
    link: "https://www.rajjewellersmumbai.com/",
    preview: "/previews/rajjewellers.png",
  },
  {
    title: "Adtalk",
    description: "Creative ad agency site with punchy case visuals and motion.",
    tags: ["Agency", "Marketing", "Creative"],
    link: "https://theadtalk.com/",
    preview: "/previews/adtalk.png",
  },
  {
    title: "Vibeharbour",
    description: "Urban streetwear brand + site. Bold visuals, crisp copy, zero fluff.",
    tags: ["Brand", "eCom", "Design"],
    link: "#",
    preview: "/previews/vibeharbour.png",
  },
  {
    title: "IES MCRC",
    description: "Institutional site for programs, faculty, admissions—clear and accessible.",
    tags: ["Education", "UI/UX", "CMS"],
    link: "https://www.mcrc.ies.edu/",
    preview: "/previews/iesmcrc.png",
  },
  {
    title: "Ace Beveragez",
    description: "Beverage brand presence—refreshing design with crisp brand storytelling.",
    tags: ["FMCG", "Branding", "Web"],
    link: "https://www.acebeveragez.com/",
    preview: "/previews/acebeveragez.png",
  },
];
          ...
          {projects.map((p, idx) => (
            <motion.a key={p.title} href={p.link} target="_blank" rel="noreferrer"
              ...
              <div className="h-40 overflow-hidden">
                <img src={p.preview} alt={`${p.title} preview`} className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105" />
              </div>
              <div className="p-4">
                <h3 className="text-lg font-medium text-white">{p.title}</h3>
                <p className="mt-1 text-sm text-neutral-300">{p.description}</p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {p.tags.map((t) => <span key={t} className="rounded-full border border-white/10 px-2 py-0.5 text-xs text-white/70">{t}</span>)}
                </div>
              </div>
            </motion.a>
          ))}
